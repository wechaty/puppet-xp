...
import {initidStruct,initStruct,initmsgStruct} from "../initStruct/all_init_Fn"
...
const getChatroomMemberNickInfoFunction = ((memberId:any, roomId:any) => {
  ...
  const nativeativeFunction: NativeFunction<void, []> = new NativeFunction(ptr(memberNickBuffAsm), 'void', [])
  nativeativeFunction()
