...
const hookLogoutEventCallback = (():NativeCallback<"void", ["int32"]> => {
  const nativeCallback:NativeCallback<"void", ["int32"]> = new NativeCallback(() => { }, 'void', ['int32'])
  const nativeativeFunction: NativeFunction<void, [number]> = new NativeFunction(nativeCallback, 'void', ['int32'])
