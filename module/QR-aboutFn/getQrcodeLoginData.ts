...
import { readString } from "../CommonFn"
const getQrcodeLoginData = () => {
  const getQRCodeLoginMgr:NativeFunction<NativePointer, []> = new NativeFunction(moduleBaseAddress.add(offset.get_qr_login_data_offset), 'pointer', [])
