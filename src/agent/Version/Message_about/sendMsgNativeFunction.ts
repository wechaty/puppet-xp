...
const sendMsgNativeFunction = (() => {
  ...
  Memory.patchCode(asmSendMsg, Process.pageSize, (code) => {
    ...
    //0x3b56a0 3.2.1.121
    cw.putCallAddress(moduleBaseAddress.add(offset.send_txt_call_offset));
  ...
  const sendMsg = (talkerId: any, content: any) => {
  ...
  return (...args: any[]) =>
    refHolder.sendMsg(...(args as [talkerId: any, content: any])); //ci  chu  bu zhi  dao dui cuo   // as [talkerId:any,content:any]
})();
export { sendMsgNativeFunction };
