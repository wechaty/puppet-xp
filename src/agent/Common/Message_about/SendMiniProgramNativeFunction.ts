import { getMyselfInfoFunction } from "../../Version/getUserData/getUserData";
import { moduleBaseAddress } from "../globalVariable";
import { initidStruct } from "../initStruct/all_init_Fn";

const SendMiniProgramNativeFunction = (
  bg_path_str: any,
  contactId: any,
  xmlstr: any
) => {
...
export { SendMiniProgramNativeFunction };
